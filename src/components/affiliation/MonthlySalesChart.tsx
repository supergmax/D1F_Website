...
export default function MonthlySalesChart({ monthlyCounts }: MonthlySalesChartProps) {
  ...
  const toggleDropdown = () => setIsRequested(!isRequested);
  const CloseDropdown = () => setIsRequested(false);
    ...
    <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white px-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6">
      <div className="flex items-center justify-between">
        ...
        <div className="relative">
          ...
          <Dropdown isOpen={isRequested} onClose={CloseDropdown} className="w-40 p-2">
