...
export default function SaasMetrics({ totalRevenue, averageProfit }: MetricsProps) {
  ...
  return (
    <div className="relative rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] overflow-hidden">
      {/* Blur & content */}
      ...
      <div className="absolute inset-0 flex items-center justify-center bg-white/60 dark:bg-black/40">
        <span className="text-xl font-semibold text-gray-800 dark:text-white">Coming Soon</span>
      </div>
    </div>
  );
}
