      ...
      <section className="py-16 bg-background dark:bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto prose prose-lg dark:text-gray-300">
            <h2 className="text-primary dark:text-primary">Introduction</h2>
            <p>
            ...
            <h2 className="text-primary dark:text-primary">Information We Collect</h2>
            <p>We may collect information about you in a variety of ways. The information we may collect includes:</p>
            <h3 className="text-primary dark:text-primary">Personal Data</h3>
            <p>
            ...
            <h3 className="text-primary dark:text-primary">Derivative Data</h3>
            <p>
            ...
            <h3 className="text-primary dark:text-primary">Financial Data</h3>
            <p>
            ...
            <h2 className="text-primary dark:text-primary">Use of Your Information</h2>
            <p>
            ...
            <h2 className="text-primary dark:text-primary">Disclosure of Your Information</h2>
            <p>
              We may share information we have collected about you in certain situations. Your information may be
              disclosed as follows:
            </p>
            <h3 className="text-primary dark:text-primary">By Law or to Protect Rights</h3>
            <p>
            ...
            <h3 className="text-primary dark:text-primary">Third-Party Service Providers</h3>
            <p>
            ...
            <h3 className="text-primary dark:text-primary">Marketing Communications</h3>
            <p>
              With your consent, or with an opportunity for you to withdraw consent, we may share your information with
              third parties for marketing purposes.
            </p>

            <h2 className="text-primary dark:text-primary">Security of Your Information</h2>
            <p>
